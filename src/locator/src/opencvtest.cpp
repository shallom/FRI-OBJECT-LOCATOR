...
Mat A=Mat(2, 5, CV_32FC1, &data);
Mat B=Mat(2, 5, CV_32FC1, &data);

vector<Mat> C;
C.push_back(A);
C.push_back(B);
readFromFile("../object_locator/src/locator/src/readyForNewPic.txt");

int numberOfPics=sscanf(readFromFile("../object_locator/src/locator/src/readyForNewPic.txt").c_str(), "%d", &numberOfPics);	
